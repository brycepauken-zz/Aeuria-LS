...
- (instancetype)initWithParentView:(UIView *)parentView {
    ...
    if(self) {
        ...
        _backgroundOverlay = [[UIView alloc] initWithFrame:_window.bounds];
        ...
        [_window addSubview:_backgroundOverlay];
        ...
        [self setCenter:CGPointMake(_window.bounds.size.width/2, _window.bounds.size.height*3/2)];
        [self.layer setCornerRadius:4];
        
        /*//create the holding scrollView
        _scrollView = [[UIScrollView alloc] initWithFrame:_window.bounds];
        [_scrollView setContentOffset:CGPointMake(0, _window.bounds.size.height)];
        [_scrollView setContentSize:CGSizeMake(_window.bounds.size.width, _window.bounds.size.height*3)];
...
+ (ALSColorPicker *)colorPickerWithParentView:(UIView *)parentView {
    return [[ALSColorPicker alloc] initWithParentView:parentView];
}
