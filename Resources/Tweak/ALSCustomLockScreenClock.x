...
- (instancetype)initWithRadius:(CGFloat)radius type:(ALSClockType)type preferencesManager:(ALSPreferencesManager *)preferencesManager {
    ...
    if(self) {
        ...
        _handInnerWidth = [[preferencesManager preferenceForKey:@"handInnerWidth"] intValue];
        _handOuterWidth = [[preferencesManager preferenceForKey:@"handOuterWidth"] intValue];
        _hourHandExtensionLength = [[preferencesManager preferenceForKey:@"hourHandExtensionLength"] intValue];
        _hourHandLength = [[preferencesManager preferenceForKey:@"hourHandLength"] intValue];
        _hourTickHeight = [[preferencesManager preferenceForKey:@"hourTickMarkHeight"] intValue];
        _hourTickInnerWidth = [[preferencesManager preferenceForKey:@"hourTickMarkInnerWidth"] intValue];
        ...
        _minuteHandExtensionLength = [[preferencesManager preferenceForKey:@"minuteHandExtensionLength"] intValue];
